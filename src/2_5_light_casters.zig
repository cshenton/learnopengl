...
pub fn main() !void {
    ...
    const cubeVertPath = try join(allocator, &[_][]const u8{ "shaders", "2_5_light_casters.vert" });
    const cubeFragPath = try join(allocator, &[_][]const u8{ "shaders", "2_5_light_casters.frag" });
