...
pub fn main() !void {
    ...
    const cubeVertPath = try join(allocator, &[_][]const u8{ "shaders", "2_3_materials.vert" });
    const cubeFragPath = try join(allocator, &[_][]const u8{ "shaders", "2_3_materials.frag" });
