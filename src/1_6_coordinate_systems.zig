...
pub fn main() !void {
    ...
    const vertPath = try join(allocator, &[_][]const u8{ "shaders", "1_6_coordinate_systems.vert" });
    const fragPath = try join(allocator, &[_][]const u8{ "shaders", "1_6_coordinate_systems.frag" });
